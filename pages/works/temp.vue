...
const clickButton = () => {
    store.eventListener({ name: "CLICK_BUTTON" });
};

const onSwiper = (swiper) => {
    store.eventListener({ name: "ON_SWIPER", data: swiper });
};

const onSlideChange = (swiper) => {
    store.eventListener({ name: "ON_SLIDE_CHANGE", data: swiper });
};
</script>
